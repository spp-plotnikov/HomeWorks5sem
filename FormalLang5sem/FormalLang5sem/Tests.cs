    ...
    class Tests
    {
        public void GLLSolverTest()
        {
            ...
            foreach (var grammarFile in _grammars)
            {
                ...
                {
                    var graphDot = File.ReadAllText("Resources\\Automata\\" + graphFile, Encoding.Default);
                    var grammarDot = File.ReadAllText("Resources\\Grammars\\" + grammarFile, Encoding.Default);
